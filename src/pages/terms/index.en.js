  ...
  content: (
    <>
      ...
      <p>
        ...
        <b>{companyName}</b>
        {' '}
or its subsidiaries and affiliates. Any use of the Contents
          without
        {' '}
        <b>{companyName}</b>
        {' '}
express written consent is strictly prohibited.
      ...
      <p>
          This website may include links to other Internet sites maintained by third parties.
        {' '}
        <b>{companyName}</b>
        {' '}
provides 'Linked Sites'
...
website.
      ...
      <p>
        <b>{companyName}</b>
        {' '}
strives to comply to trademark and copyright laws in all our publications, including images, graphics,
          sound, video, and text elements. Content created by
        <b>{companyName}</b>
        {' '}
(including images, graphics, sound, video, and text
          elements) can only be used and replicated by express written consent by
        <b>{companyName}</b>
.
      </p>
      <h3> 5. Privacy </h3>
      <p>
        ...
        {' '}
        <b>{companyName}</b>
. We reserve our rights to take legal steps against publishers of such 'Spam emails'.
      </p>
      <h3> 6. Legal force of Disclaimer </h3>
      <p>
          This Disclaimer is to be understood as part of the web offering of
        {' '}
        <b>{companyName}</b>
. If parts of the disclaimer should not
      ...
      <p>
        <b>{companyName}</b>
        {' '}
uses Tracking software of third parties in order to monitor the usage of the site. The analysis tools use
      ...
      <p>
          ...
          connect to the servers of the social network.
        {' '}
        <b>{companyName}</b>
        {' '}
has no way of finding out which data is transferred. To

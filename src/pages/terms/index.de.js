  ...
  content: (
    <>
      ...
      <p>
        <b>{companyName}</b>
        {' '}
übernimmt keinerlei Gewähr für die Aktualität, Korrektheit, Vollständigkeit oder Qualität der bereitgestellten
...
, welche sich auf Schäden materieller oder ideeller Art beziehen,
       ...
       unvollständiger Informationen verursacht wurden, sind grundsätzlich ausgeschlossen, sofern seitens
        <b>{companyName}</b>
...
behält es sich ausdrücklich vor, Teile der Seiten oder das gesamte Angebot ohne
      ...
      <p>
       ...
       des Autors liegen, würde eine Haftungsverpflichtung ausschließlich in dem Fall in Kraft treten, in dem
        {' '}
        <b>{companyName}</b>
...
erklärt hiermit ausdrücklich, dass zum Zeitpunkt der Linksetzung keine illegalen
       ...
       oder die Urheberschaft der verlinkten/verknüpften Seiten hat
        ...
        <b>{companyName}</b>
        {' '}
keinerlei Einfluss. Deshalb distanziert
        <b>{companyName}</b>
        {' '}
sich hiermit ausdrücklich von allen Inhalten aller verlinkten / verknüpften Seiten, die nach der Linksetzung
      ...
      <p>
        <b>{companyName}</b>
        {' '}
ist bestrebt, in allen Publikationen die Urheberrechte der verwendeten Bilder, Grafiken, Tondokumente,
       Videosequenzen und Texte zu beachten, von
        <b>{companyName}</b>
        {' '}
selbst erstellte Bilder, Grafiken, Tondokumente, Videosequenzen
       ...
       und Texte in anderen elektronischen oder gedruckten Publikationen ist ohne ausdrückliche Zustimmung von
        <b>{companyName}</b>
       nicht gestattet.
      </p>
      <h3> 5. Datenschutz </h3>
      <p>
       ...
       wie Postanschriften, Telefon- und Faxnummern sowie Emailadressen durch Dritte zur Übersendung von nicht ausdrücklich
      ...
      <p>
       ...
       (1600 Amphitheatre Parkway, Mountain View, CA 94043, USA). Google Analytics verwendet auch "Cookies". Die durch
       den Cookie erzeugten Informationen über Ihre Benutzung dieser Website (einschließlich Ihrer IP-Adresse) werden
       ...
       den Cookie (einschließlich Ihrer IP-Adresse) auch verhindern, wenn Sie das unter dem folgenden Link verfügbare
      ...
      <p>
       ...
       mir") enthält, baut Ihr Browser eine direkte Verbindung mit den Servern des Sozialen Netzwerks auf.
        {' '}
        <b>{companyName}</b>
        erhält keine Kenntnis von den übermittelten Daten. Um zu vermeiden, dass die Sozialen Netzwerke während Ihres
       Besuchs auf den Websites
        {' '}
        <b>{companyName}</b>
        {' '}
Daten über Sie sammeln, müssen Sie sich zu Beginn Ihres Besuchs
       auf einer Website
        {' '}
        <b>{companyName}</b>
        {' '}
bei sämtlichen Sozialen Netzwerken ausloggen. Bei Nutzung der Social Connect

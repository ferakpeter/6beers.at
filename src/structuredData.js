import {
  assocPath, curry, pipe, prop, keys,
} from 'ramda';
 ...
 */
const renameType = (obj) => keys(obj).reduce((newObj, key) => {
...
const addDatePublished = (markdownRemark) => assocPath(['frontmatter', 'structuredData', 'datePublished'],
...
const addHeadline = (markdownRemark) => assocPath(['frontmatter', 'structuredData', 'headline'],
...
const addArticleBody = (markdownRemark) => assocPath(['frontmatter', 'structuredData', 'articleBody'],
  getArticleBody(markdownRemark), markdownRemark);

const addAuthor = (structuredData) => (structuredData.author
  ? {
    ...structuredData,
...
const addLanguage = (markdownRemark) => assocPath(['fields', 'langKey'],
